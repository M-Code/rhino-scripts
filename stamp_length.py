...
Prompts the user to select curves or sub-object edges, accumulates total length
per parent object, and writes the result as a "length" UserText attribute.
If any selected object already has a "length" key, asks before overwriting.
"""
